...
/**
 * Intuit QBMS API Wallet Update Response.
 *
 * @since 2.3.3
 */
class WC_Intuit_QBMS_API_Wallet_Update_Response extends WC_Intuit_QBMS_API_Response {

	// Nothing to handle here for now
}
