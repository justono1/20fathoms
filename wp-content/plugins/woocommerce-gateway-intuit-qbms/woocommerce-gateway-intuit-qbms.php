 ...
 * @since 2.3.0
 */
class WC_Intuit_Payments_Loader {
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot clone instances of %s.', get_class( $this ) ), '2.3.0' );
	}
	...
	public function __wakeup() {
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot unserialize instances of %s.', get_class( $this ) ), '2.3.0' );
	}
	...
	public function init_plugin() {
		...
		require_once( plugin_dir_path( __FILE__ ) . 'class-wc-intuit-payments.php' );
	...
	/**
	 * Gets the main \WC_Intuit_Payments_Loader instance.
	 *
	 * Ensures only one instance can be loaded.
	 *
	 * @since 2.3.0
	 *
	 * @return \WC_Intuit_Payments_Loader
	 */
...
// fire it up!
WC_Intuit_Payments_Loader::instance();
